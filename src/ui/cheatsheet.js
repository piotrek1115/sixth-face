...
export const FACE_RULES = {
  ...
  Thrust: 'Attack with range 2, held over your own front rank.',
  Loose: 'Shoot 2–4 tiles ahead. Arcs over your own men; stopped by a wall or by the first enemy. Useless against someone already in contact — and loosing lowers the bow, so you must tip the die to load it again.',
